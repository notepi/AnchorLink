...
职责：
  ...
  - 产出 data/price/processed/price_data_product.json
...
MARKET_NORMALIZED_PATH = STORAGE.normalized_dir / "market_data_normalized.parquet"
MARKET_RAW_PATH = STORAGE.get_raw_path("market_data.parquet")
DAILY_BASIC_PATH = STORAGE.get_raw_path("daily_basic.parquet")
MONEYFLOW_PATH = STORAGE.get_raw_path("moneyflow.parquet")
DEFAULT_OUTPUT_PATH = STORAGE.get_processed_path("price_data_product.json")
