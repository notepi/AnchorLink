...
输出：data/price/normalized/market_data_normalized.parquet
"""
...
DEFAULT_INPUT_PATH = STORAGE.get_raw_path("market_data.parquet")
DEFAULT_OUTPUT_PATH = STORAGE.normalized_dir / "market_data_normalized.parquet"
